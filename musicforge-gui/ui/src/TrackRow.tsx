...
// P2-16：记忆化。回调签名已改为 `(tr: Track) => void`，调用方用 useCallback 传稳定函数
// （依赖具体稳定方法如 selApi.toggle / liked.toggle），使无关重渲染（滚动 / 选择态切换）
// 不再触发每行重渲染——十万曲库虚拟列表的关键渲染优化。
